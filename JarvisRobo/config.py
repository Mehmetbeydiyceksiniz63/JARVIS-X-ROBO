...
class Config(object):
    ...
    OWNER_ID = "7268753735" # If you dont know, run the bot and do /id in your private chat with it, also an integer
    
    SUPPORT_CHAT = "kumsalmuzikk"  # Your own group for support, do not add the @
    START_IMG = ""
